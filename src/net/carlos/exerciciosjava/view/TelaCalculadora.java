package net.carlos.exerciciosjava.view;

import net.carlos.exerciciosjava.model.Calculadora;
...
public class TelaCalculadora {
    ...
    public TelaCalculadora() {
        ...
        cmdSomar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try{
                    txtResult.setText(calculo.soma(Double.parseDouble(txtV1.getText()), Double.parseDouble(txtV2.getText())));
                }catch (Exception ex){
                    JOptionPane.showMessageDialog(null, ex.getMessage(), "Aconteceu um erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        cmdSubtrair.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try{
                    txtResult.setText(calculo.subtracao(Double.parseDouble(txtV1.getText()), Double.parseDouble(txtV2.getText())));
                }catch (Exception ex){
                    JOptionPane.showMessageDialog(null, ex.getMessage(), "Aconteceu um erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        cmdMultiplicar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try{
                    txtResult.setText(calculo.multiplicacao(Double.parseDouble(txtV1.getText()), Double.parseDouble(txtV2.getText())));
                }catch (Exception ex){
                    JOptionPane.showMessageDialog(null, ex.getMessage(), "Aconteceu um erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        cmdDividir.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try{
                    txtResult.setText(calculo.divisao(Double.parseDouble(txtV1.getText()), Double.parseDouble(txtV2.getText())));
                }catch (Exception ex){
                    JOptionPane.showMessageDialog(null, ex.getMessage(), "Aconteceu um erro", JOptionPane.ERROR_MESSAGE);
                }
            }
